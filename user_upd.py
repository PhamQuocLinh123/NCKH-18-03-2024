...
class Student:
    def __init__(self,root):
        ...
        # ====title=========
        self.txt = "Quản lý thông tin người dùng có trong hệ thống  "#tiêu đề
        self.count = 0
        self.text = ''
        ...
        label_Update_att = Label(Left_frame, bg="white", fg="red2", text="Thông tin người dùng",
        ...
        class_student_frame = LabelFrame(Left_frame, bd=2, bg="white", relief=RIDGE, text="Thông tin người dùng ",
                                          font=("times new roman", 11, "bold"))
        class_student_frame.place(x=5, y=145, width=640, height=400)

        # Nhập Id học sinh
        studentID_label = Label(class_student_frame, text="Mã người dùng :", font=("times new roman", 11, "bold"), bg="white")
        ...
        #Tên học sinh
        studentName_label = Label(class_student_frame, text="Tên người dùng:", font=("times new roman", 11, "bold"),
                                bg="white")
        ...
        #Lớp học
        class_div_label = Label(class_student_frame, text="Phòng:", font=("times new roman", 11, "bold"),
                                  bg="white")
        ...
        #CMND
        roll_no_label = Label(class_student_frame, text="Căn cước công dân ", font=("times new roman", 11, "bold"),
                                  bg="white")
        ...
        #SĐT
        phone_label = Label(class_student_frame, text="Số điện thoại:", font=("times new roman", 11, "bold"),
                          bg="white")
        ...
        img_btn1 = img_btn1.resize((120, 35), PIL.Image.BILINEAR)
        ...
        img_btn2 = img_btn2.resize((170, 35), PIL.Image.BILINEAR)
        self.photobtn2 = ImageTk.PhotoImage(img_btn2)
        take_photo_btn = Button(btn_frame1, text="Thêm khuôn mặt",command=self.generate_dataset, font=("times new roman", 11, "bold"), bd=0,bg="white",cursor='hand2' ,activebackground='white',
        ...
        img_btn3 = img_btn3.resize((105, 35), PIL.Image.BILINEAR)#resize ảnh
        ...
        self.student_table.heading("id", text="Mã")
        ...
        label_studentsb = Label(Underright_frame, bg="white", fg="red2", text="Quản lý phòng",
                                font=("times new roman", 12, "bold"))
        ...
        search_combo = ttk.Combobox(Underright_frame, font=("times new roman", 11, "bold"),
                                    ...
                                    state="readonly",
                                    width=11)
        search_combo["values"] = ("Mã phòng", "Tên phòng")
        search_combo.current(0)
        ...
        # Lớp học
        studentid_label = Label(Underright_frame, text="Mã Phòng:", font=("times new roman", 12, "bold"),
                                bg="white", width=12)
        ...
        self.StudentTable.heading("class", text="Mã Phòng")
