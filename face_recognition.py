...
class Face_Recognition:
    ...
    def __init__(self,root):
        ...
        self.notify_label = Label(self.notify_frame, text="Thông báo: Vui lòng chọn nghành của bạn để mở Camera!!!", font=("times new roman", 11, "bold"),
                             bg="white",fg="red")
        ...
        self.Right_frame = LabelFrame(self.root, bd=2, bg="white", relief=RIDGE, text="Xác định danh tính",
    ...
    def mark_attendance(self,i,r,n,d,face_cropped):
        ...
        while True:# khi camera mở lên không có lỗi
            ...
            if(i not in chkarray):
                ...
                print("Người dùng:" + n + " không có trong danh sách ")
