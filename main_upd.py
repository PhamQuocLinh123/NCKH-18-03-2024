...
class Face_Recognition_System(Toplevel):
    ...
    def click_home(self):
        ...
        self.home_dashboard_frame = ImageTk.PhotoImage \
            (file='ImageFaceDetect\\imgg3.jpg')
        ...
        total_students.place(x=210, y=90)
        ...
        total_class = Label(home_frame, text=f"ĐẾM \n SỐ \n NGƯỜI",
                            font=("times new roman", 30, "bold"),
                            background="white", fg='#e67c0b')
        total_class.place(x=210, y=370)
        ...
        # self.ex_button.place(x=790,y=340,width=260,height=180)
    ...
    def click_manage(self):
        ...
        button_att = Button(manage_frame, text="DS Nhận Diện", font=("times new roman", 14, "bold"),
